...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
  ...
  , ((modMask, xK_F5), spawn $ "spotify" )
  , ((modMask, xK_F6), spawn $ "gimp" )
  , ((modMask, xK_F7), spawn $ "" )
  , ((modMask, xK_F8), spawn $ "" )
  , ((modMask, xK_F9), spawn $ "" )
  , ((modMask, xK_F10), spawn $ "" )
  , ((modMask, xK_F11), spawn $ "" )
  , ((modMask, xK_F12), spawn $ "" )
  ...
  , ((modMask .|. shiftMask , xK_Return ), spawn $ "termite -e ranger")
...
main = do
    ...
    -- xmproc0 <- spawnPipe "xmobar -x 0 /home/brokholy/.config/xmobar/xmobarrc"
